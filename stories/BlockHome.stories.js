export default {title: 'Block Home'};

export const SimpleBlock = () =>
  `<block-home title="Une démarche éco-conception web" img-src="eco-conception-web.jpg" cta-label="Découvrir notre démarche" cta-target="/">
